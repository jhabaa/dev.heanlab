...
<template>
  <div class="wrapper-project-details">
    ...
    <div class="project-data">
      ...
      <a :href="project.Link" v-if="project?.Link" class="external-link">
        See the project
      </a>
    </div>
    ...
    <div class="content">
      ...
      <div v-if="project?.Frames?.length" class="project-frames">
        <div class="project-frames-vertical">
          <div
            v-for="frame in frames.filter((e) => e.includes('vertical'))"
            :key="frame"
            class="project-frame-vertical"
          >
        ...
        <div class="project-frames-horizontal">
          <div
            v-for="frame in frames.filter((e) => e.includes('horizontal'))"
            :key="frame"
            class="project-frame-horizontal"
          >
            <img :src="getImageurl(frame)" :alt="frame" />
          </div>
        </div>
